      ...
      <Paper className="home-paper">
        ...
        >
          ...
          <div className="profile-info-row">
            ...
            <span>
              {!!userProfileInfo?.role
                ? ROLES.find((role) => role.en === userProfileInfo?.role)?.ru
                : '-'}
            </span>
          </div>
          <div className="profile-info-row">
          ...
          <div className="profile-info-row">
            ...
            <span>
              {!!userProfileInfo?.date_reg
                ? formatDate(userProfileInfo?.date_reg)
                : '-'}
            </span>
          </div>
          <div className="profile-info-row">
          ...
          <div className="profile-info-row">
            ...
            <span
              className={`user-status-${userProfileInfo?.is_active ? 'active' : 'inactive'}`}
            >
              {userProfileInfo?.is_active ? 'Активный' : 'Заблокирован'}
            </span>
          </div>
        </Paper>
      </Paper>
